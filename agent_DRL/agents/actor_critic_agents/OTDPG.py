...
from agent_DRL.agents.HER_Base import HER_Base


class OTDPG(HER_Base, TD3_OTD):
    """This class is modified from TD3-HER, so it may equal to TD3_HER"""
    agent_name = "OTDPG"

    def __init__(self, config):
        self.is_state_dict = True
        TD3_OTD.__init__(self, config, is_her=True)
        self.is_state_dict = True
