...
from .DDPG_OTD import DDPG_OTD
from agent_DRL.exploration_strategies.Gaussian_Exploration import Gaussian_Exploration


class TD3_OTD(DDPG_OTD):
    """A TD3 Agent from the paper Addressing Function Approximation Error in Actor-Critic Methods (Fujimoto et al. 2018) for improvement
    https://arxiv.org/abs/1802.09477"""
    agent_name = "TD3-OTD"

    def __init__(self, config, is_her=False):
        self.is_state_dict = is_her
        DDPG_OTD.__init__(self, config, is_her)
